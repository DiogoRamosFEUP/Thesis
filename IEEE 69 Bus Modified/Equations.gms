...
Equation44,Equation45,Equation46,Equation47,Equation48;
...
Equation01(n,t)..                         -Sum(l,Pl(l,t)*MapNL(n,l)+(SBase*P_Loss(l,t))$(MapNL(n,l)=1))+Sum(g$MapGN(g,n),Pg(g,t))=e=P_Restored(n,t);
Equation02(n,t)..                         -Sum(l,Ql(l,t)*MapNL(n,l)+(SBase*Q_Loss(l,t))$(MapNL(n,l)=1))+Sum(g$MapGN(g,n),Qg(g,t))=l=Q_Restored(n,t);


Equation47(n,t)$(not Lambda(n))..
...
Equation48(n,t)$(ord(t) > 1 and Priority(n) > 0.1)..       LoadStatus(n,t-1) - LoadStatus(n,t) =l= 0;